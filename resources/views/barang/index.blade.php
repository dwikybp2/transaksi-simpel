...
<body>
    ...
    <div class="container mt-4">
        <div class="card shadow-lg">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <div class="gap-4">
                    <a class="btn btn-danger btn-sm" href="{{ url('/') }}">Dashboard</a>
    ...
    <script>
        ...
        function fetchData(page, search) {
            $.ajax({
                url: `{{ url('api/barangs') }}?page=${page}&search=${search}`,
                type: "GET",
                dataType: "json",
                success: function(response) {
                    let tableBody = "";
                        ...
                        tableBody += `
                            <tr>
                                ...
                                <td class="text-center">
                                    <a title="Detail Transaksi" class="btn btn-info btn-sm text-white" href="barangs/${item.id}/transaksi">${item?.transaksis_count}</a>
                                </td>
                                <td>
